    ...
    <?php require_once 'header.html'; ?>
        ...
        <div id="mesin" class="page <?= ($_GET['view'] ?? '')=='mesin' ? 'active' : '' ?>">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>
                                ...
                                ?>
                                Nama Mesin
                                <a href="?view=mesin&sort_col=nama_mesin&sort_dir=<?= $next_dir ?>" style="color:white;">
                                    <i class="fa fa-arrows-v"></i>
                                </a>
                            </th>
                            <th>
                                Kapasitas Per Jam
                                <a href="?view=mesin&sort_col=kapasitas_per_jam&sort_dir=<?= ($sort_col == 'kapasitas_per_jam' && $sort_dir == 'ASC') ? 'DESC' : 'ASC' ?>" style="color:white;">
                                    <i class="fa fa-arrows-v"></i>
                                </a>
                            </th>
                            <th>
                                Tahun Pembuatan
                                <a href="?view=mesin&sort_col=tahun_pembuatan&sort_dir=<?= ($sort_col == 'tahun_pembuatan' && $sort_dir == 'ASC') ? 'DESC' : 'ASC' ?>" style="color:white;">
                                    <i class="fa fa-arrows-v"></i>
                                </a>
                            </th>
                            <th>Aksi</th>
            ...
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a href="?view=mesin&page=1<?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>">&laquo;</a>
                    <a href="?view=mesin&page=<?= $page-1 ?><?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>">&lsaquo;</a>
                <?php endif; ?>
                ...
                <?php for($i = max(1, $page-2); $i <= min($page+2, $total_pages); $i++): ?>
                    ...
                    <?php else: ?>
                        <a href="?view=mesin&page=<?= $i ?><?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>"><?= $i ?></a>
                    <?php endif; ?>
                <?php endfor; ?>

                <?php if ($page < $total_pages): ?>
                    <a href="?view=mesin&page=<?= $page+1 ?><?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>">&rsaquo;</a>
                    <a href="?view=mesin&page=<?= $total_pages ?><?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>">&raquo;</a>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            <div class="actions">
