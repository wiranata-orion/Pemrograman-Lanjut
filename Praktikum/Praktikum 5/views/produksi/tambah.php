...
<head>
    ...
    <link rel="stylesheet" href="../views/produksi/styles.ss" />
    <link rel="stylesheet" href="../views/produksi/styles_input.css" />
    <?php
...
<body>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="index.php?view=tambah_mesin">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_mesin" name="nama_mesin" placeholder="Nama Mesin" required />
                </div>
                <div class="form-group">
    ...
    <div class="page-wrapper active">
        ...
        <div class="form-container">
            <h2><i class="fas fa-box"></i> Tambah Bahan Baku</h2>
    ...
    <div class="page-wrapper active">
        ...
        <div class="form-container">    
            <h2><i class="fas fa-user-tie"></i> Tambah Operator</h2>
    ...
    <div class="page-wrapper active">
        ...
        <div class="form-container">
            <h2><i class="fas fa-exchange-alt"></i> Tambah Produksi</h2>
            <form method="POST" action="index.php?view=tambah_produksi">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="jumlah_lembar" name="jumlah_lembar" required />
                </div>
                <div class="form-group">
    ...
    <div class="page-wrapper active">
        ...
        <div class="form-container">
            <h2><i class="fas fa-map-marker-alt"></i> Tambah Quality Check</h2>
