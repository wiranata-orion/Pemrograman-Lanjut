    ...
    <div>
        ...
        <div class="table-container">
            <form id="bulkForm" method="POST" action="index.php?view=bulk_action">
                ...
                <?php $total_pages = ceil($total_records / $records_per_page); if ($total_pages > 1): ?>
                    <div class="pagination">
                        ...
                        <?php for($i = max(1, $page-2); $i <= min($page+2, $total_pages); $i++): ?>
                            ...
                            <?php else: ?><a href="?view=quality_check&page=<?= $i ?><?= isset($_GET['sort_col']) ? '&sort_col='.$_GET['sort_col'].'&sort_dir='.$_GET['sort_dir'] : '' ?>"><?= $i ?></a><?php endif; ?>
                        <?php endfor; ?>
